    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_add_site:
                ...
                AddAddress(name, mobile, size, tv_time.getText().toString().trim(), detailSite);

                break;
        }
    }

    private void AddAddress(String name, String mobile, String size, String time, String detailSite) {
        params.clear();
        myDialog.show();
        if (gd_id != -1) {
            params.put("gd_id", gd_id);
