...
public class ExamineOrderDetailsActivity extends BaseActivity implements View.OnClickListener, OnCancelListener {
    ...
    private ExamineOrderDetailsAdapter detailsAdapter;
    ...
    public void initView() {
        ll_isOilPaint = (AutoLinearLayout) findViewById(R.id.ll_isOilPaint);
        ...
        detailsAdapter = new ExamineOrderDetailsAdapter(this, null);
        mRvOrder.setLayoutManager(new LinearLayoutManager(this));
        mRvOrder.setAdapter(detailsAdapter);
        getData();
    }
    ...
    private void initData() {
        detailsAdapter.addAll(orderDetail.getMaterials());
        ...
        if (orderDetail.getTotalInfo().getIs_oil_pain()==1){
